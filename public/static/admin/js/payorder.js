define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'payorder/index',
        add_url: 'payorder/add',
        edit_url: 'payorder/edit',
        delete_url: 'payorder/delete',
        export_url: 'payorder/export',
        modify_url: 'payorder/modify',
    };
            ...
            ea.table.render({
                ...
                cols: [[
                   ...
                   // {field: 'ua', title: '用户ID',minWidth: 190},
                    ...
                    {minWidth: 80, field: 'vtitle', title: '资源名称',minWidth:200},
                    /*{
                        field: '',
                        title: '资源名称',
                        templet:function(val){
                    ...
                    {minWidth: 120, field: 'price', title: '打赏金额'},
                    {minWidth: 120, field: 'smoney', title: '提现金额'},
