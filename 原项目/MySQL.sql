...
CREATE TABLE `ds_category` (
  ...
  `ctitle` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '分类名称',
  `image` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT '分类图片 {image}',
...
(34, 'biaoyu', 'basic', '网站标语', '</p >⭐鲜衣怒马少年时，一夜望尽長安花。\r\n</p >⭐人生自信两百年，会当击水三千里。\r\n</p >⭐零扣量、高质量、高稳定性的系统，主打一流品牌,打造一流服务☑。'),
...
(64, 'zb_gd', 'short_video', '直播页更多跳转地址', '版权所有@老表-只要你健康'),
(66, 'zb_mp4', 'short_video', '直播页视频外链', 'http://cctvalih5ca.v.myalicdn.com/live/cctv1_2/index.m3u8'),
(67, 'title', 'basic', '前台站点名称', '富贵短视频盒子系统'),
(68, 'zb_img', 'short_video', '直播页封面图', '版权所有@老表-只要你健康'),
(69, 'h_img', 'short_video', '滑动广告图片', '/uploads/20211017/8599c64c8ad02600f9ee2229d9d46530.png'),
(70, 'poundage', 'setup', '默认代理费率', '40'),
(71, 'kouliang', 'setup', '默认代理抽单', '3'),
(72, 'min_fee', 'setup', '最低提现金额', '100'),
(73, 'min_publish', 'setup', '最低发布金额', '-1'),
(74, 'pay_model', 'setup', '默认支付通道1', 'caihongyi'),
(75, 'pay_model1', 'setup', '默认支付通道2', '-'),
(76, 'short', 'setup', '默认短网址', 'bdpro'),
(77, 'jiance', 'setup', '域名自动切换', 'wechat'),
...
CREATE TABLE `ds_domain_lib` (
  ...
  `domain` varchar(1000) CHARACTER SET utf8 NOT NULL COMMENT '中转域名',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态 {radio} (0:禁用,1:正常)',
  `q_status` int(11) NOT NULL DEFAULT '1',
  `creator_id` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '0' COMMENT '创建者',
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间'
...
CREATE TABLE `ds_domain_rule` (
  ...
  `domain` varchar(500) CHARACTER SET utf8 NOT NULL COMMENT '落地域名',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态 {radio} (0:禁用,1:正常)',
  `creator_id` varchar(100) CHARACTER SET utf8 DEFAULT '0' COMMENT '创建者',
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
...
--
-- 转存表中的数据 `ds_domain_rule`
--

INSERT INTO `ds_domain_rule` (`id`, `uid`, `type`, `domain`, `status`, `creator_id`, `create_time`, `buy_time`) VALUES
(40, 10086, 1, '120.46.35.75', 1, 'admin', 1668233564, NULL),
(41, 10086, 2, '120.46.35.75', 1, 'admin', 1668233579, NULL);
...
CREATE TABLE `ds_hezi` (
  ...
  `short_url` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT '短连接',
...
CREATE TABLE `ds_link` (
  ...
  `video_url` text CHARACTER SET utf8 COMMENT '视频链接',
  `money` varchar(11) CHARACTER SET utf8 NOT NULL DEFAULT '0.00' COMMENT '打赏金额',
  `money2` varchar(11) CHARACTER SET utf8 NOT NULL DEFAULT '0.00' COMMENT '包月',
  `money1` varchar(11) CHARACTER SET utf8 NOT NULL DEFAULT '0.00' COMMENT '包日',
  ...
  `img` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '资源图片',
  `number` int(11) DEFAULT '0' COMMENT '打赏人数',
  `stock_id` int(11) DEFAULT '0' COMMENT '来自公共',
  `try_see` int(11) NOT NULL DEFAULT '0' COMMENT '试看',
  `create_time` int(11) DEFAULT NULL COMMENT '创建时间'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='代理片库';
...
CREATE TABLE `ds_muban` (
  ...
  `title` varchar(150) CHARACTER SET utf8 DEFAULT NULL COMMENT '标题',
  `muban` varchar(150) CHARACTER SET utf8 DEFAULT NULL COMMENT '模版标识',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态 {radio} (0:禁用,1:正常)',
...
INSERT INTO `ds_muban` (`id`, `uid`, `title`, `muban`, `status`, `image`, `desc`, `create_time`, `delete_time`) VALUES
(1, 1, '【H1】', '', 1, '/upload/tp/mb1.png', '简约紫', 1649053925, NULL),
(2, 1, '【H2】', '', 1, '/upload/tp/mb2.png', '简约粉', 1649054938, NULL),
(3, 1, '【H3】', '', 1, '/upload/tp/mb3.png', '简约红', 1649056517, NULL),
(4, 1, '【H4】', '', 1, '/upload/tp/mb4.png', '带短视频+直播', 1649056843, NULL),
(5, 1, '【H5】', '', 1, '/upload/tp/mb5.png', '带直播', 1649056975, NULL),
(6, 1, '【H6】', '', 1, '/upload/tp/mb6.png', '经典粉', 1649057088, NULL),
(7, 1, '【H7】', '', 1, '/upload/tp/mb7.png', '经典蓝', 1649058126, NULL),
(8, 1, '【H8】', '', 1, '/upload/tp/mb8.png', '靓推红', 1649058171, NULL),
(9, 1, '【H9】', '', 1, '/upload/tp/mb9.png', '靓推蓝', 1649058236, NULL),
(10, 1, '【H10】', '', 1, '/upload/tp/mb10.png', '简约+短视频', 1649058276, NULL),
(11, 1, '【H11】', '', 1, '/upload/tp/mb11.png', '简约白', 1649058352, NULL),
(12, 1, '【H12】', '', 1, '/upload/tp/mb12.png', '至尊黑+短视频', 1649058517, NULL);
...
CREATE TABLE `ds_notify` (
  `id` int(11) NOT NULL,
  `creator_id` varchar(250) CHARACTER SET utf8 DEFAULT '' COMMENT '创建者',
...
INSERT INTO `ds_notify` (`id`, `creator_id`, `title`, `type`, `content`, `is_show`, `create_time`) VALUES
(20, 'admin', '微信价格设置方案', 1, '&lt;b&gt;微信价格会自动上浮 63%&amp;nbsp; &amp;nbsp;请谨慎设置 .&amp;nbsp;&lt;/b&gt;&lt;div&gt;&lt;b&gt;&amp;nbsp; &amp;nbsp;如： 设置了5元&amp;nbsp; 等于 5+5*63=9元&amp;nbsp; 如遇到小数会自动进一位&lt;/b&gt;&lt;/div&gt;', 1, 1649088235);
...
CREATE TABLE `ds_pay_order` (
  ...
  `ua` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '客户端唯一标识',
  `des` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '描述记录',
  `vid` int(11) NOT NULL DEFAULT '0' COMMENT '资源ID',
  `vtitle` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT '资源名称',
  `pay_channel` varchar(255) CHARACTER SET utf8 DEFAULT '' COMMENT '支付渠道',
  `ip` varchar(64) CHARACTER SET utf8 NOT NULL DEFAULT '0' COMMENT 'ip',
  ...
  `is_kouliang` enum('2','1') CHARACTER SET utf8 NOT NULL DEFAULT '2' COMMENT '是否扣量 {radio} (1:不扣量,2:扣量)',
  `transact` varchar(64) CHARACTER SET utf8 NOT NULL COMMENT '支付单号',
  `is_month` enum('1','2') CHARACTER SET utf8 DEFAULT '1' COMMENT '是否包月 {radio} ( 1:否,2:是)',
  `is_date` enum('1','2') CHARACTER SET utf8 DEFAULT '1' COMMENT '是否包日 {radio} ( 1:否,2:是)',
  `is_tj` int(11) DEFAULT '1',
...
CREATE TABLE `ds_pay_setting` (
  `id` int(11) NOT NULL,
  `title` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT '支付名称',
  `app_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付ID',
  `app_key` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '支付秘钥',
  `pay_url` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '支付网关',
  `pay_channel` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '执行方法',
...
CREATE TABLE `ds_point_decr` (
  `id` int(11) NOT NULL,
  `ua` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `vid` varchar(30) COLLATE utf8mb4_estonian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_estonian_ci COMMENT='点播卷消费记录';
...
CREATE TABLE `ds_point_logs` (
  `id` int(11) NOT NULL,
  `uid` int(11) DEFAULT NULL,
  `ip` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `time` varchar(222) COLLATE utf8mb4_estonian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_estonian_ci COMMENT='短视频日志';
...
CREATE TABLE `ds_price` (
  `id` int(11) NOT NULL,
  `pay_model` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `is_dan` int(11) DEFAULT '0',
  `dan_fee` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `is_day` int(11) DEFAULT '0',
  `date_fee` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `is_week` int(11) DEFAULT '0',
  `week_fee` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `is_month` int(11) DEFAULT '0',
  `month_fee` varchar(255) COLLATE utf8mb4_estonian_ci DEFAULT NULL,
  `uid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_estonian_ci COMMENT='通道价格设置';

--
-- 转存表中的数据 `ds_price`
--

INSERT INTO `ds_price` (`id`, `pay_model`, `is_dan`, `dan_fee`, `is_day`, `date_fee`, `is_week`, `week_fee`, `is_month`, `month_fee`, `uid`) VALUES
(6, '1', 1, '5', 1, '20', 0, '3', 0, '4', 72),
(7, '2', 1, '9', 1, '25', 0, '6', 0, '7', 72),
(8, '1', 2, '', 1, '25', 0, NULL, 0, NULL, 114),
(9, '2', 1, '7', 1, '25', 0, NULL, 0, NULL, 114),
(10, '2', 1, '7', 1, '25', 0, NULL, 0, NULL, 115),
(11, '1', 2, '', 1, '', 0, NULL, 0, NULL, 115),
(12, '2', 1, '7', 1, '25', 0, NULL, 0, NULL, 116),
(13, '1', 2, '7', 1, '25', 0, NULL, 0, NULL, 116),
(14, '1', 1, '5', 1, '20', 0, NULL, 0, NULL, 117),
(15, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 117),
(16, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 118),
(17, '2', 1, '7', 1, '25', 0, NULL, 0, NULL, 118),
(18, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 113),
(19, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 113),
(20, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 120),
(21, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 120),
(22, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 121),
(23, '1', 1, '6', 0, '28', 0, NULL, 0, NULL, 121),
(24, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 122),
(25, '2', 1, '8', 1, '48', 0, NULL, 0, NULL, 122),
(26, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 123),
(27, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 123),
(28, '1', 1, '6', 0, '28', 0, NULL, 0, NULL, 124),
(29, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 124),
(30, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 125),
(31, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 125),
(32, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 129),
(33, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 129),
(34, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 130),
(35, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 130),
(36, '1', 1, '5', 1, '22', 0, NULL, 0, NULL, 131),
(37, '2', 1, '6', 1, '22', 0, NULL, 0, NULL, 131),
(38, '2', 1, '6', 1, '28', 0, NULL, 0, NULL, 132),
(39, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 132),
(40, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 133),
(41, '1', 1, '5', 1, '22', 0, NULL, 0, NULL, 133),
(42, '2', 1, '1', 1, '1', 0, NULL, 0, NULL, 134),
(43, '1', 1, '2', 1, '3', 0, NULL, 0, NULL, 134),
(44, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 136),
(45, '2', 1, '7', 1, '35', 0, NULL, 0, NULL, 136),
(46, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 137),
(47, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 137),
(48, '2', 1, '4', 1, '20', 0, NULL, 0, NULL, 138),
(49, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 138),
(50, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 139),
(51, '2', 1, '6', 1, '26', 0, NULL, 0, NULL, 139),
(52, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 141),
(53, '2', 1, '6', 1, '26', 0, NULL, 0, NULL, 141),
(54, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 142),
(55, '2', 1, '6', 1, '26', 0, NULL, 0, NULL, 142),
(56, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 148),
(57, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 148),
(58, '1', 1, '6', 0, '25', 0, NULL, 0, NULL, 158),
(59, '2', 1, '7', 1, '30', 0, NULL, 0, NULL, 158),
(60, '2', 1, '7', 1, '30', 0, NULL, 0, NULL, 159),
(61, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 159),
(62, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 160),
(63, '2', 1, '4', 1, '15', 0, NULL, 0, NULL, 160),
(64, '2', 1, '6', 1, '26', 0, NULL, 0, NULL, 161),
(65, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 161),
(66, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 151),
(67, '2', 1, '7', 1, '26', 0, NULL, 0, NULL, 151),
(68, '2', 1, '7', 1, '26', 0, NULL, 0, NULL, 150),
(69, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 150),
(70, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 146),
(71, '2', 1, '7', 1, '26', 0, NULL, 0, NULL, 146),
(72, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 149),
(73, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 149),
(74, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 147),
(75, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 147),
(76, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 162),
(77, '2', 1, '7', 1, '30', 0, NULL, 0, NULL, 162),
(78, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 163),
(79, '2', 1, '7', 1, '35', 0, NULL, 0, NULL, 163),
(80, '1', 1, '6', 1, '28', 0, NULL, 0, NULL, 164),
(81, '2', 1, '7', 1, '35', 0, NULL, 0, NULL, 164),
(82, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 154),
(83, '2', 1, '7', 1, '25', 0, NULL, 0, NULL, 154),
(84, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 155),
(85, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 155),
(86, '2', 1, '7', 1, '30', 0, NULL, 0, NULL, 165),
(87, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 165),
(88, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 156),
(89, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 156),
(90, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 157),
(91, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 157),
(92, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 166),
(93, '2', 1, '7', 1, '26', 0, NULL, 0, NULL, 166),
(94, '2', 1, '0', 0, '29', 0, NULL, 0, NULL, 167),
(95, '1', 1, '15', 0, '29', 0, NULL, 0, NULL, 167),
(96, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 152),
(97, '2', 1, '7', 1, '26', 0, NULL, 0, NULL, 152),
(98, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 168),
(99, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 168),
(100, '2', 1, '7', 1, '22', 0, NULL, 0, NULL, 170),
(101, '1', 1, '6', 0, '18', 0, NULL, 0, NULL, 170),
(102, '1', 1, '6', 1, '20', 0, NULL, 0, NULL, 140),
(103, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 140),
(104, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 171),
(105, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 171),
(106, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 172),
(107, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 172),
(108, '1', 1, '5', 1, '20', 0, NULL, 0, NULL, 178),
(109, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 178),
(110, '1', 1, '6', 1, '22', 0, NULL, 0, NULL, 179),
(111, '2', 1, '7', 1, '28', 0, NULL, 0, NULL, 179),
(112, '1', 1, '6', 1, '25', 0, NULL, 0, NULL, 181),
(113, '2', 1, '6', 1, '25', 0, NULL, 0, NULL, 181),
(114, '1', 1, '10', 1, '25', 1, '10', 1, '20', 182),
(115, '2', 1, '10', 1, '25', 1, '10', 1, '20', 182),
(116, '2', 1, '6', 1, '22', 0, NULL, 0, NULL, 183),
(117, '1', 1, '7', 1, '25', 1, '40', 1, '52', 183),
(118, '1', 1, '8', 1, '30', 1, '88', 1, '99', 184),
(119, '2', 1, '6', 0, '25', 0, '', 0, '', 184);
...
CREATE TABLE `ds_quantity` (
  ...
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='抽单设置';
...
CREATE TABLE `ds_stock` (
  ...
  `title` varchar(250) CHARACTER SET utf8 NOT NULL COMMENT '资源名称',
  `url` text CHARACTER SET utf8 COMMENT '资源链接',
  `time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `image` text CHARACTER SET utf8 COMMENT '视频图片 {image}',
  `number` int(11) DEFAULT '0' COMMENT '打赏人数',
...
(1, 0, NULL, '/static/admin/images/head.jpg', 'admin', '123456', 'wx123456', '9f98ea3da8025db5bc4235dfac1f7a7650211592', 'admin', '0.00', '0.00', 'self', 'chuanqi', '', 0, 0, 25, 0, 1, 1, 1, '1', 0, 0, NULL, 0, 4, '123', '11', 864, 0, 1, '[{\"val\":\"2\",\"bl\":50},{\"val\":\"2\",\"bl\":50}]', '999888', 1604912635, 1714798954, NULL, 0),
(184, 0, '7', '/static/admin/images/head.jpg', '123321', '', '', '9f98ea3da8025db5bc4235dfac1f7a7650211592', '123321', '0.00', '0.00', 'tinyurl', '0', NULL, 0, 0, 25, 5, 1, 0, 0, '1', 0, 0, '6', 0, 1, NULL, '', 8, 0, 1, NULL, NULL, 1668236811, 1714222160, NULL, 0);
...
(6, '游客权限', 0, 1, '', 'youke', 1588227513, 1589591751, 1589591751),
(7, '代理组', 0, 1, '普通代理权限【无开通下级的权限】', 'daili', 1606465003, 1650971513, NULL),
(8, '演示组', 0, 1, '管理员演示权限', NULL, 1650970158, 1650970458, 1650970458),
(9, '总代组', 0, 1, '总代理权限【可以使用邀请码发展下级】', NULL, 1650972063, 1650972085, NULL),
(10, '演示管理员', 0, 1, '演示管理员【无权限】', NULL, 1650973862, 1650974043, NULL),
(11, '演示总代理', 0, 1, '演示总代理【无权限】', NULL, 1652020416, 1652020427, NULL);
...
(249, 0, '商城管理', 'fa fa-list', '', '', '_self', 0, 1, '', 1589439884, 1604914167, 1604914167),
...
(265, 262, '代理账户', 'fa fa-list', '', '', '_self', 0, 1, '', 1605336962, 1605337331, 1605337331),
...
--
-- 转存表中的数据 `ds_system_uploadfile`
--

INSERT INTO `ds_system_uploadfile` (`id`, `upload_type`, `original_name`, `url`, `image_width`, `image_height`, `image_type`, `image_frames`, `mime_type`, `file_size`, `file_ext`, `sha1`, `create_time`, `update_time`, `upload_time`) VALUES
(1, 'local', 'Screenshot_20240426_200730_com.tencent.mm.jpg', 'http://xinuocs.testlike.cn/upload/20240426/4b57be840fae9f743518795d93195ec0.jpg', '', '', '', 0, 'image/jpeg', 0, 'jpg', '', 1714143466, NULL, NULL);
...
CREATE TABLE `ds_user_money_log` (
  ...
  `order_on` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT '订单号',
  `create_time` int(11) DEFAULT NULL COMMENT '创建时间'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_estonian_ci COMMENT='点播卷';
...
ALTER TABLE `ds_link`
  ...
  ADD KEY `uid_t` (`uid`,`stock_id`) USING BTREE;
--
-- 表的索引 `ds_muban`
--
...
ALTER TABLE `ds_pay_order`
  ...
  ADD KEY `uid` (`uid`) USING BTREE,
  ADD KEY `uids` (`status`,`uid`) USING BTREE,
  ADD KEY `uc` (`uid`,`status`,`createtime`) USING BTREE;
