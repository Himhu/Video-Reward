...
| **架构设计重构** | 🔄 部分完成 | 50% | 高 | Service层已建立，Outlay控制器已重构 |
| **重复控制器** | 🔄 部分完成 | 50% | **最高** | Outlay系列已完成，Number/Account系列待合并 |
...
|------|--------|--------|--------|--------|----------|
| 代码重复度 | 65% | 35% | 25% | 30% | 10% |
| 控制器数量 | 34个 | 31个 | 20个 | 3个 | 11个 |
| 重复文件数量 | 231个 | 16个 | 10个 | 215个 | 6个 |
| 维护成本 | 高 | 中低 | 低 | 60%降低 | 10%降低 |
| 开发效率 | 低 | 中高 | 高 | 60%提升 | 20%提升 |
| 架构合理性 | 60% | 80% | 85% | 20% | 5% |
